/* tc-bonjour.c -- Assemble code for bonjour
...
extern const bonjour_opc_info_t bonjour_opc_info[128];
...
{
  int count;
  const bonjour_opc_info_t *opcode;
  opcode_hash_control = hash_new ();

  /* Insert names into hash table.  */
  for (count = 0, opcode = bonjour_form1_opc_info; count++ < 64; opcode++)
    hash_insert (opcode_hash_control, opcode->name, (char *) opcode);

  for (count = 0, opcode = bonjour_form2_opc_info; count++ < 4; opcode++)
    hash_insert (opcode_hash_control, opcode->name, (char *) opcode);

  for (count = 0, opcode = bonjour_form3_opc_info; count++ < 10; opcode++)
    hash_insert (opcode_hash_control, opcode->name, (char *) opcode);
...
md_assemble (char *str)
{
    ...
    *op_end = 0;
    ...
    opcode = (bonjour_opc_info_t *) hash_find (opcode_hash_control, op_start);
    *op_end = pend;
